...
# 7.- Cifrado de mensajes
    print("--------------------------------------------")
    print("Colocar el mensaje en palabras")
    mensaje=input("Mensaje para cifrar : ")
    mensaje_cifrado=cifrarmensaje(mensaje,publica)
    print("Mensaje Cifrado : "+ str(mensaje_cifrado))

# 8.- Descifrado de mensajes
    print("--------------------------------------------")
    print("Colocar el mensaje cifrado(los numeros)")
    mensaje_cifrado=input("Mensaje para descifrar : ")
    mensaje_descifrado=descifrarmensaje(mensaje_cifrado,privada)
